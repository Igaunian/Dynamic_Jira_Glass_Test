...
Feature: The 3rd party post functions of the workflow transition appear in Glass documentation
  Scenario Outline: the custom post functions of the workflow appear on Glass
    ...
    Then the 3rd party <post functions> are listed in the table

    Examples:
      |Glass documentation page|issue type|transition|post functions|
      |https://jira2.codecool.codecanvas.hu/projects/JGDTP?selectedItem=com.codecanvas.glass:glass|Epic|Finally|Adds the text WTF - This is the text to be added to the comment. as PREFIX to the entered transition-comment.|
