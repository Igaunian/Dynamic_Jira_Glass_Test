Feature: The workflow editing link works in Glass documentation
  Scenario Outline: the editing link works on Glass
    ...
    Examples:
      ...
      |codecooladmin|https://jira2.codecool.codecanvas.hu/projects/JGDTP?selectedItem=com.codecanvas.glass:glass|Bug|https://jira2.codecool.codecanvas.hu/plugins/servlet/project-config/JGDTP/workflows|
