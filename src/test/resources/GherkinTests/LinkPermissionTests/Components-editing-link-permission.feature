Feature: The components editing link works according to the permissions in Glass documentation
  Scenario Outline: the editing link works according to the permissions on Glass
    ...
    Then there <is / is not> the editing link icon next to the Components headline
